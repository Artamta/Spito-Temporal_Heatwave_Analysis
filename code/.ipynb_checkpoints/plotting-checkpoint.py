...
def plot_hits(number_families,fgv,v,plot_title):
  ...
  for F in families:
    ...
    obj['fig'].savefig('results/clustering_step1/Heatwavedays_%s_Cluster_%s.png' % (plot_title,F),
...
def plot_families(number_families,fgv,v,plot_title):
  ...
  for F in families:
    ...
    obj['fig'].savefig('results/seasonal_clustering_step2/%s_Cluster_%s.png' % (plot_title,F),
                       dpi=300, bbox_inches='tight')
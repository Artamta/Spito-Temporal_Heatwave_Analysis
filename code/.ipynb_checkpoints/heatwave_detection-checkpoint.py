...
def calc_percentile(a_list):
    threshold = np.percentile(a_list,99)#i am using 99 perecentile
    return threshold
...
result.to_csv(path_or_buf = "/home/raj.ayush/results/heatwaves/thresh_new.csv", index=False)
...
rex.to_csv(path_or_buf = "/home/raj.ayush/results/heatwaves/extr_new.csv", index=False)
...
# save heatwaves
cpv.to_csv(path_or_buf = "/home/raj.ayush/results/heatwaves/cpv_new%s.csv" % b, index=False)
g.v.to_csv(path_or_buf = "/home/raj.ayush/results/heatwaves/gv_new%s.csv" % b, index=False)

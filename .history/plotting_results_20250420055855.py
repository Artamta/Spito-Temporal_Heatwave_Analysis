...
OUTPUT_DIR = "add_your_path_here"  # Replace with your desired output directory
...
def make_argparser():
    ...
    parser.add_argument("-cpv", "--cpv", help="Path to the supernodes tables.", type=str)
    parser.add_argument("-n", "--number", help="Number of heatwaves to be plotted.", type=int)
...
# Sort the heatwaves by the specified column
